...
<header>
    ...
    <div style=" margin-top: 15px;  width: 100%; text-align: left; font-size: 10px;">
        <table style="padding-left: 25px; padding-right: 25px; border-collapse:collapse;">
            <thead>
                <tr>
        ...
        <table style=" border-collapse:collapse; width: 100%;">
            ...
            <tbody>
                ...
                <tr style="border: black 1px solid;">
                    ...
                    <td style="border: black 1px solid;padding: 4px;">{{$materia_calificacion->calificacion}}</td>
                    ...
                    <td style="border: black 1px solid;padding: 4px;">{{$materia_calificacion->porcentaje}}</td>
                </tr>
                <?php $contador++; ?>
                @break
                @endif
